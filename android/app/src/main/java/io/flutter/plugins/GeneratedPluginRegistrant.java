...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.launcher.plus.flutter_launcher_plus.FlutterLauncherPlusPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_launcher_plus, com.launcher.plus.flutter_launcher_plus.FlutterLauncherPlusPlugin", e);
    }
    try {
